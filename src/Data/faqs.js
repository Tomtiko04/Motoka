// The FAQ answers, shared by the public help page and the in-app one.
//
// They were inline in Landing/v2/pages/FaqPage.jsx, which meant the signed-in
// app could not show the same answers without copying them — and a copy drifts.
// Both surfaces now read this file.

const faqs = [
  {
    q: "How do I create an account on Motoka?",
    a: "Tap Register and sign up with your name, email, phone number, and a password. You can also start a renewal without an account and create one at checkout.",
  },
  {
