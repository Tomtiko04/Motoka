...
export default function PaymentReceipt() {
  ...
  const finalPaymentType = paymentType || location.state?.paymentType || 'vehicle_paper';
          ...
          <div className="bg-gray-50 rounded-lg p-5">
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className={`text-sm font-medium ${payment.status === "success" ? "text-green-600" : payment.status === "pending" ? "text-yellow-600" : "text-red-600"} capitalize`}>{payment.status}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium text-gray-800 capitalize">{payment.payment_gateway || 'N/A'}</span>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gray-50 rounded-lg p-5">
              ...
              <div className="space-y-1">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-800">{monicreditResponse.data?.channel || 'Bank Transfer'}</span>
                </div>
                <div className="flex justify-between">
                ...
                {monicreditResponse.data?.customer && (
                  <>
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium text-gray-800">{monicreditResponse.data.customer.account_number}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-xs text-gray-600">Bank Name:</span>
                      <span className="text-sm font-medium text-gray-800">{monicreditResponse.data.customer.bank_name}</span>
                    </div>
                  </>
                )}
              </div>
