...
function Mobile() {
  return (
    <div className="mt-10 grid grid-cols-1 place-items-center gap-10 bg-[#DAECFC] p-20 px-0 sm:px-20 sm:pe-0 pb-0 lg:grid-cols-2 lg:h-screen items-end">
      <div className="flex h-full flex-col justify-between text-[56px] text-[#2389E3] px-10 sm:px-0">
        <div>
          {" "}
          <h3 className="text-[56px] font-bold text-[#2389E3]">
        ...
        <div className="pb-20">
          <h3 className="text-[36px] font-medium text-[#05243F]">
            Coming soon on
          </h3>
          <div className="mt-6 grid h-[104px] sm:w-[419px] items-center justify-evenly gap-6 rounded-[15px] bg-[#2389E3] px-6 grid-cols-2">
