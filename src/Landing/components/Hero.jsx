        ...
        <div className="p-4 sm:p-10 text-center">
            <div className="bg-[#2287E0] rounded-[20px] p-6 sm:p-10 text-white flex flex-col items-center justify-center pt-15 sm:pt-32">
                ...
                <div className="hidden bg-white rounded-[10px]  text-black sm:flex items-center  mt-10 text-base  sm:text-xl font-semibold w-full max-w-[700px]">
                    ...
                    <button className="bg-[#38DA99] py-3 px-5 sm:py-4 sm:px-6 rounded-[10px] text-nowrap">Renew Now</button>
                </div>
                <div className=" rounded-[10px] text-black flex flex-col sm:hidden items-center  mt-10 text-base  sm:text-xl font-semibold w-full max-w-[700px]">
                    ...
                    <button className="bg-[#38DA99] py-3 px-5 sm:py-4 sm:px-6 rounded-[10px] text-nowrap w-full">Renew Now</button>
                </div>
                {/* <input type="text" placeholder="hello world" /> */}
